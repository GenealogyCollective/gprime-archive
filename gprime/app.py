...
from .gen.const import LOCALE as glocale
...
# Setup logging
#
# Ideally, this needs to be done before any Gprime modules are
...
# code. That unfortunately initializes Locale, so it has its own
...
def exc_hook(type, value, tb):
    ...
    #from gprime.gen.utils.debug import format_exception
    import traceback
