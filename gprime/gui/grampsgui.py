...
from gprime.gen.const import DATA_DIR, IMAGE_DIR, GTK_GETTEXT_DOMAIN
from gprime.gen.constfunc import has_display, lin
...
def _display_translator_message(parent=None):
    ...
    if config.get('behavior.translator-needed'):
        ...
        from gprime.gen.utils.locale import INCOMPLETE_TRANSLATIONS
        language = None
        ...
        if language:
            from .dialog import WarningDialog
            from gprime.gen.const import URL_MAILINGLIST
...
class Gramps:
    ...
    def __init__(self, argparser):
        ...
        from gprime.cli.arghandler import ArgHandler
