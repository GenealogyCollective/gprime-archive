...
from gprime.gen.filters import GenericFilterFactory, GenericFilter, rules
...
class GuiStyleOption(GuiEnumeratedListOption):
    ...
    def __on_style_edit_clicked(self, *obj):
        ...
        from gprime.gen.plug.docgen import StyleSheetList
...
from gprime.gen.plug import menu as menu
_OPTIONS = (
