...
from gprime.gen.proxy import (PrivateProxyDb,
                              LivingProxyDb,
                              FilterProxyDb,
...
class WriterOptionBox:
    ...
    def edit_filter(self, namespace, filter_obj):
        ...
        from gprime.gen.filters import FilterList, GenericFilterFactory
    ...
    def edit_filter_save(self, filterdb, namespace):
        ...
        """
        from gprime.gen.filters import CustomFilters
        from gprime.gen.filters import reload_custom_filters
        filterdb.save()
