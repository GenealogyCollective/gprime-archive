...
from gprime.gen.const import URL_MANUAL_PAGE, DOCGEN_OPTIONS
from gprime.gen.errors import (DatabaseError, FilterError, ReportError,
                               WindowActiveError)
...
from gprime.gen.plug.docgen import StyleSheet, StyleSheetList
...
class ReportDialog(ManagedWindow):
    ...
    def setup_other_frames(self):
        from gprime.gui.plug._guioptions import GuiTextOption
