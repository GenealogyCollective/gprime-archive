...
from gprime.gen.const import TOOL_OPTIONS
from gprime.gen.display.name import displayer as name_displayer
from gprime.gen.errors import WindowActiveError
from gprime.gen.plug._options import (Options, OptionHandler, OptionList,
                         OptionListCollection)
from gprime.gen.plug import (TOOL_DEBUG, TOOL_ANAL, TOOL_DBPROC, TOOL_DBFIX,
...
class CommandLineTool:
    ...
    def parse_option_str(self):
        from gprime.cli.plug import _convert_str_to_match_type
