...
from gprime.gen.plug import START
from gprime.gen.plug import REPORT
from gprime.gen.plug.report._constants import standalone_categories
...
from gprime.gen.const import (HOME_DIR, ICON, URL_BUGTRACKER, URL_HOMEPAGE,
                              URL_MAILINGLIST, URL_MANUAL_PAGE, URL_WIKISTRING,
                              WIKI_EXTRAPLUGINS, URL_BUGHOME)
from gprime.gen.constfunc import is_quartz
...
class ViewManager(CLIManager):
    ...
    **Overview**
    ...
    def __build_main_window(self):
        ...
        self.window.set_title("%s - Gprime" % _('No Family Tree'))
        self.window.show()
    ...
    def __init_lists(self):
        ...
        self._file_action_list = [
            ...
            ('HomePage', None, _('Gprime _Home Page'), None, None,
             home_page_activate),
            ('MailingLists', None, _('Gprime _Mailing Lists'), None, None,
    ...
    def _post_load_newdb_gui(self, filename, filetype, title=None):
        ...
        if self.dbstate.db.readonly:
            msg = "%s (%s) - Gprime" % (name, _('Read Only'))
    ...
    def post_close_db(self):
        ...
        """
        self.undo_history_close()
        self.uistate.window.set_title("%s - Gprime" % _('No Family Tree'))
        self.actiongroup.set_sensitive(False)
        self.readonlygroup.set_sensitive(False)
        self.undohistoryactions.set_sensitive(False)
    ...
    def quick_backup(self, obj):
        ...
        if dbackup == Gtk.ResponseType.APPLY:
            ...
            if include.get_active():
                from gprime.plugins.export.exportpkg import PackageWriter
