...
from gprime.gen.errors import WindowActiveError, FilterError
from ..filters import SearchBar
from ..widgets.menuitem import add_menuitem
from gprime.gen.const import CUSTOM_FILTERS
from gprime.gen.utils.debug import profile
...
class ListView(NavigationView):
    ...
    def write_tabbed_file(self, name, type):
        ...
        """
        from gprime.gen.utils.docgen import CSVTab, ODSTab
        ofile = None
