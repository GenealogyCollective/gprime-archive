...
#
#-------------------------------------------------------------------------
from gprime.gen.datehandler import displayer, format_time, get_date_valid
from gprime.gen.display.name import displayer as name_displayer
from gprime.gen.lib import EventRoleType, FamilyRelType
from .flatbasemodel import FlatBaseModel
from gprime.gen.utils.db import get_marriage_or_fallback
