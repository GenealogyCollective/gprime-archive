...
def exportData(db, filename,
    ...
    with OpenFileOrStdout(filename, encoding="utf-8") as fp:
        ...
        # Notes
        # ---------------------------------
        for obj in db.iter_notes(order_by=("gramps_id", "ASC")):
            write_line(fp, obj)
            count += 1
        ...
        # Event
        # ---------------------------------
        for obj in db.iter_events(order_by=("gramps_id", "ASC")):
            write_line(fp, obj)
            count += 1
            callback(100 * count/total)
        ...
        # Person
        # ---------------------------------
        for obj in db.iter_people(order_by=("gramps_id", "ASC")):
            write_line(fp, obj)
            count += 1
            callback(100 * count/total)
        ...
        # Family
        # ---------------------------------
        for obj in db.iter_families(order_by=("gramps_id", "ASC")):
            write_line(fp, obj)
            count += 1
            callback(100 * count/total)
        ...
        # Repository
        # ---------------------------------
        for obj in db.iter_repositories(order_by=("gramps_id", "ASC")):
            write_line(fp, obj)
            count += 1
            callback(100 * count/total)
        ...
        # Place
        # ---------------------------------
        for obj in db.iter_places(order_by=("gramps_id", "ASC")):
            write_line(fp, obj)
            count += 1
            callback(100 * count/total)
        ...
        # Source
        # ---------------------------------
        for obj in db.iter_sources(order_by=("gramps_id", "ASC")):
            write_line(fp, obj)
            count += 1
            callback(100 * count/total)
        ...
        # Citation
        # ---------------------------------
        for obj in db.iter_citations(order_by=("gramps_id", "ASC")):
            write_line(fp, obj)
            count += 1
            callback(100 * count/total)
        ...
        # Media
        # ---------------------------------
        for obj in db.iter_media(order_by=("gramps_id", "ASC")):
            write_line(fp, obj)
            count += 1
            callback(100 * count/total)
