...
from gprime.gui.widgets.styledtexteditor import StyledTextEditor
from gprime.gui.widgets import SimpleButton
from gprime.gen.lib import StyledText, Note, NoteType
from gprime.gen.filters import GenericFilterFactory, rules
from gprime.gen.utils.db import navigation_label
...
class ToDoGramplet(Gramplet):
    ...
    def edit_clicked(self, obj):
        ...
        """
        from gprime.gui.editors import EditNote
        note_handle = self.note_list[self.current]
        note = self.dbstate.db.get_note_from_handle(note_handle)
        try:
