# encoding: utf-8
#
# Gprime - a GTK+/GNOME based genealogy program - What Next Gramplet plugin
#
...
#
#------------------------------------------------------------------------
from gprime.gen.lib import EventType, FamilyRelType
...
class WhatNextGramplet(Gramplet):
    ...
    def build_options(self):
        ...
        """
        from gprime.gen.plug.menu import NumberOption, EnumeratedListOption
