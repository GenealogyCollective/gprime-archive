...
from gprime.gen.simple import SimpleAccess, SimpleDoc
from gprime.gui.plug.quick import QuickTable
from gprime.gen.utils.file import media_path_full
from gprime.gui.plug.quick import run_quick_report_by_name_direct
