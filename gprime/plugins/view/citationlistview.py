...
#
#-------------------------------------------------------------------------
from gprime.gui.views.treemodels.citationlistmodel import CitationListModel
from gprime.gen.plug import CATEGORY_QR_CITATION
from gprime.gen.lib import Citation, Source
from gprime.gui.views.listview import ListView, TEXT, MARKUP, ICON
from gprime.gen.utils.db import get_citation_referents
...
from gprime.gui.editors import EditCitation, DeleteCitationQuery
from gprime.gui.filters.sidebar import CitationSidebarFilter
from gprime.gui.merge import MergeCitation
