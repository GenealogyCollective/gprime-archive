...
#
#-------------------------------------------------------------------------
from gprime.gui.views.listview import TEXT, MARKUP, ICON
from gprime.gui.views.treemodels.citationtreemodel import CitationTreeModel
from gprime.gen.plug import CATEGORY_QR_SOURCE_OR_CITATION
from gprime.gen.lib import Citation, Source
from gprime.gui.views.listview import ListView
from gprime.gen.utils.db import (get_source_and_citation_referents,
                                get_citation_referents)
from gprime.gui.views.bookmarks import CitationBookmarks
...
from gprime.gui.editors import EditCitation, DeleteCitationQuery, EditSource, \
    DeleteSrcQuery
from gprime.gui.filters.sidebar import SourceSidebarFilter
from gprime.gui.merge import MergeCitation, MergeSource
