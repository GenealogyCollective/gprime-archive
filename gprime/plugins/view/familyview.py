...
#
#-------------------------------------------------------------------------
from gprime.gen.lib import Family
from gprime.gui.views.listview import ListView, TEXT, MARKUP, ICON
from gprime.gui.views.treemodels import FamilyModel
from gprime.gui.editors import EditFamily
from gprime.gui.views.bookmarks import FamilyBookmarks
...
from gprime.gui.filters.sidebar import FamilySidebarFilter
from gprime.gui.merge import MergeFamily
from gprime.gen.plug import CATEGORY_QR_FAMILY
...
class FamilyView(ListView):
    ...
    def remove(self, obj):
        ...
        """
        from gprime.gui.dialog import QuestionDialog, MultiSelectDialog
