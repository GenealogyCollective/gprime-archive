...
#
#-------------------------------------------------------------------------
from gprime.gui.utils import open_file_with_default_application
from gprime.gui.views.listview import ListView, TEXT, MARKUP, ICON
from gprime.gui.views.treemodels import MediaModel
from gprime.gen.config import config
from gprime.gen.utils.file import (media_path, relative_path, media_path_full,
                                   create_checksum)
from gprime.gen.utils.db import get_media_referents
from gprime.gui.views.bookmarks import MediaBookmarks
from gprime.gen.mime import get_type, is_valid_type
from gprime.gen.lib import Media
from gprime.gen.db import DbTxn
from gprime.gui.editors import EditMedia, DeleteMediaQuery
from gprime.gen.errors import WindowActiveError
from gprime.gui.filters.sidebar import MediaSidebarFilter
from gprime.gui.merge import MergeMedia
from gprime.gui.ddtargets import DdTargets
from gprime.gui.dialog import ErrorDialog
from gprime.gen.plug import CATEGORY_QR_MEDIA
