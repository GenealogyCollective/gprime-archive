...
#
#-------------------------------------------------------------------------
from gprime.gen.lib import Repository
from gprime.gui.views.listview import ListView, TEXT, MARKUP, ICON
from gprime.gui.views.treemodels import RepositoryModel
from gprime.gui.views.bookmarks import RepoBookmarks
from gprime.gen.errors import WindowActiveError
from gprime.gen.config import config
from gprime.gui.editors import EditRepository, DeleteRepositoryQuery
from gprime.gui.ddtargets import DdTargets
from gprime.gui.dialog import ErrorDialog
from gprime.gui.filters.sidebar import RepoSidebarFilter
from gprime.gui.merge import MergeRepository
from gprime.gen.plug import CATEGORY_QR_REPOSITORY
