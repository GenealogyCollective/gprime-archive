...
from gprime.gui.editors import EditSource, DeleteSrcQuery
from gprime.gui.filters.sidebar import SourceSidebarFilter
from gprime.gui.merge import MergeSource
from gprime.gen.plug import CATEGORY_QR_SOURCE
